...
public interface ArticleRepository extends JpaRepository<Article, Long> {
  ...
  @Query("SELECT article FROM Article article WHERE article.title LIKE :keywordInTitle ESCAPE '/' AND (article.isPublic = true OR article.user.id = :userId) AND article.createdAt BETWEEN :begin AND :end")
  ...
  @Query("SELECT article FROM Article article WHERE article.content LIKE :keywordInContent ESCAPE '/' AND (article.isPublic = true OR article.user.id = :userId) AND article.createdAt BETWEEN :begin AND :end")
  ...
  @Query("SELECT article FROM Article article WHERE article.title LIKE :keywordInTitle ESCAPE '/' AND article.content LIKE :keywordInContent ESCAPE '/' AND (article.isPublic = true OR article.user.id = :userId) AND article.createdAt BETWEEN :begin AND :end")
